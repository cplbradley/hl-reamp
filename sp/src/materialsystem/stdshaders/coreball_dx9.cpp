...
#include "include/coreball_vs20.inc"
#include "include/coreball_ps20b.inc"

#define MAXBLUR 1

BEGIN_VS_SHADER( CoreBall, 
			  "Help for Core" )
	...
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( CORERADIUS, SHADER_PARAM_TYPE_INTEGER, "430", "" );
		SHADER_PARAM( CORECOORDINATES, SHADER_PARAM_TYPE_VEC3, "[0 0 0]", "" );
	END_SHADER_PARAMS
	SHADER_INIT_PARAMS()
	{
		...
		IShaderDynamicAPI* pShaderAPI, int nPass, VertexCompressionType_t vertexCompression ) 
	{
		...
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( coreball_vs20 );
			SET_STATIC_VERTEX_SHADER_COMBO( MODEL,  bIsModel );
			SET_STATIC_VERTEX_SHADER( coreball_vs20 );


			DECLARE_STATIC_PIXEL_SHADER( coreball_ps20b );
			...
			SET_STATIC_PIXEL_SHADER( coreball_ps20b );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( coreball_vs20 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING,  pShaderAPI->GetCurrentNumBones() > 0 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
			SET_DYNAMIC_VERTEX_SHADER( coreball_vs20 );

			DECLARE_DYNAMIC_PIXEL_SHADER( coreball_ps20b );
			SET_DYNAMIC_PIXEL_SHADER_COMBO( PIXELFOGTYPE, pShaderAPI->GetPixelFogCombo() );
			SET_DYNAMIC_PIXEL_SHADER( coreball_ps20b );
			...
			SetPixelShaderConstant(12, CORERADIUS);
			...
			if( bHasFlowmap )
			{
				...
				SetPixelShaderConstant(9, CORECOORDINATES);
				SetPixelShaderConstant( 10, FLOWMAPTEXCOORDOFFSET );
			}
		}
		Draw();
	}
