...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT(AE_HAMMER_EVENT1, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_HAMMER_EVENT2, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_HAMMER_EVENT3, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_HAMMER_EVENT4, AE_TYPE_SERVER);
}