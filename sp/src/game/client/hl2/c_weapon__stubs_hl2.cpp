...
//STUB_WEAPON_CLASS( weapon_rocket, WeaponRocket, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS(	weapon_rocket, WeaponRocket, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS( weapon_pumpshotgun, WeaponPumpShotgun, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS(weapon_plasmarifle, WeaponPlasmaRifle, C_HLSelectFireMachineGun);
STUB_WEAPON_CLASS(weapon_bfg, WeaponBFG, C_BaseHLCombatWeapon);
