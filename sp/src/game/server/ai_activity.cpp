...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_CROUCH_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_CROUCH_WALK);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_FIRE);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_IDLE);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_JUMP);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_RELOAD);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_RUN);
	ADD_ACTIVITY_TO_SR(ACT_HLR_SUPERSHOTGUN_WALK);

	ADD_ACTIVITY_TO_SR(ACT_HLR_IDLE_CHAINGUN);
	ADD_ACTIVITY_TO_SR(ACT_HLR_RUN_CHAINGUN);
	ADD_ACTIVITY_TO_SR(ACT_HLR_JUMP_CHAINGUN);

	ADD_ACTIVITY_TO_SR(ACT_HLR_JUMP_ROCKETLAUNCHER);
	ADD_ACTIVITY_TO_SR(ACT_HLR_RUN_ROCKETLAUNCHER);
	ADD_ACTIVITY_TO_SR(ACT_HLR_IDLE_ROCKETLAUNCHER);

	ADD_ACTIVITY_TO_SR(ACT_HLR_IDLE_GRENADELAUNCHER);
	ADD_ACTIVITY_TO_SR(ACT_HLR_RUN_GRENADELAUNCHER);

	ADD_ACTIVITY_TO_SR(ACT_HLR_IDLE_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_HLR_RUN_RIFLE);
	ADD_ACTIVITY_TO_SR(ACT_HLR_FIRE_RIFLE);

	ADD_ACTIVITY_TO_SR(ACT_HLR_GROUNDPOUND_START);
	ADD_ACTIVITY_TO_SR(ACT_HLR_GROUNDPOUND_END);


	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_FIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_FIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_FIRE3);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_FIRE4);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_IDLE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_IDLE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_IDLE3);
	ADD_ACTIVITY_TO_SR(ACT_VM_GRENADELAUNCHER_IDLE0);
