...
const Sampler_t SAMPLER_DETAIL2 = SHADER_SAMPLER13;
const Sampler_t SAMPLER_DETAIL3 = SHADER_SAMPLER14;
const Sampler_t SAMPLER_DETAILMASK = SHADER_SAMPLER15;
...
BEGIN_VS_SHADER(PBR, "PBR shader")
    ...
    SHADER_DRAW
    {
        ...
        if (IsSnapshotting())
        {
            ...
            if (bMultiDetail)
            {
                pShaderShadow->EnableTexture(SAMPLER_DETAIL2, true);
                pShaderShadow->EnableTexture(SAMPLER_DETAIL3, true);
            }
