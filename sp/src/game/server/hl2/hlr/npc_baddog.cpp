...
//
// Replace occurances of CNPCBadDog with the new NPC's
...
//=========================================================
//=========================================================
class CNPCBadDog : public CAI_BaseNPC
{
	DECLARE_CLASS(CNPCBadDog, CAI_BaseNPC);
...
LINK_ENTITY_TO_CLASS(npc_baddog, CNPCBadDog);
IMPLEMENT_CUSTOM_AI(npc_citizen, CNPCBadDog);


//---------------------------------------------------------
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC(CNPCBadDog)
...
// Output :
//-----------------------------------------------------------------------------
void CNPCBadDog::InitCustomSchedules(void)
{
	INIT_CUSTOM_AI(CNPCBadDog);

	ADD_CUSTOM_TASK(CNPCBadDog, TASK_MYCUSTOMTASK);

	ADD_CUSTOM_SCHEDULE(CNPCBadDog, SCHED_MYCUSTOMSCHEDULE);

	ADD_CUSTOM_ACTIVITY(CNPCBadDog, ACT_MYCUSTOMACTIVITY);

	ADD_CUSTOM_CONDITION(CNPCBadDog, COND_MYCUSTOMCONDITION);
}
