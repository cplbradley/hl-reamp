...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_FIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_FIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_FIRE3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_FIRE4);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_IDLE0);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_IDLE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_IDLE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_GRENADELAUNCHER_IDLE3);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_SUPERSHOTGUN_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_SUPERSHOTGUN_FIRE);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_SUPERSHOTGUN_RELOAD);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_IDLE_CHAINGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_RUN_CHAINGUN);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_JUMP_CHAINGUN);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_IDLE_ROCKETLAUNCHER);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_RUN_ROCKETLAUNCHER);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_RUN_RIFLE);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_IDLE_RIFLE);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_FIRE_RIFLE);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_IDLE_GRENADELAUNCHER);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_RUN_GRENADELAUNCHER);

	REGISTER_SHARED_ACTIVITY(ACT_HLR_GROUNDPOUND_END);
	REGISTER_SHARED_ACTIVITY(ACT_HLR_GROUNDPOUND_START);
