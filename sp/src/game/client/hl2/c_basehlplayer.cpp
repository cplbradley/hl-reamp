...
C_BaseHLPlayer::C_BaseHLPlayer()
{
	...
	AddVar(&m_Local.m_vecAbsPunchAngle, &m_Local.m_iv_vecAbsPunchAngle, LATCH_SIMULATION_VAR);
	AddVar(&m_Local.m_vecAbsPunchAngleVel, &m_Local.m_iv_vecAbsPunchAngleVel, LATCH_SIMULATION_VAR);
	m_flZoomStart		= 0.0f;
	m_flZoomEnd			= 0.0f;
	m_flZoomRate		= 0.0f;
