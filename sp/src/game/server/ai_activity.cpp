...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_DRAW_CLASSIC);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_CLASSIC);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_CLASSIC);
	ADD_ACTIVITY_TO_SR(ACT_VM_SECONDARYATTACK_CLASSIC);
