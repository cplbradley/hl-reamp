...
class CWeaponSuperShotgun : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CWeaponSuperShotgun, CBaseHL2MPCombatWeapon);
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponSuperShotgun::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponSuperShotgun::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponSuperShotgun::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
