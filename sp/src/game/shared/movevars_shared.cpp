...
#define DEFAULT_GRAVITY_STRING	"1050"
#else
...
ConVar	sv_maxspeed		( "sv_maxspeed", "700", FCVAR_NOTIFY | FCVAR_REPLICATED);
#else
ConVar	sv_maxspeed		( "sv_maxspeed", "900", FCVAR_NOTIFY | FCVAR_REPLICATED);
#endif // CSTRIKE_DLL
...
#else
ConVar	sv_airaccelerate(  "sv_airaccelerate", "1000", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY);
...
#else
ConVar	sv_friction		( "sv_friction","10", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "World friction." );
#endif // DOD_DLL || CSTRIKE_DLL
...
ConVar	sv_maxvelocity	( "sv_maxvelocity","8000", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis." );
ConVar	sv_stepsize		( "sv_stepsize","18", FCVAR_NOTIFY | FCVAR_REPLICATED);
