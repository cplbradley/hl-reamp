...
static ConVar	g_debug_antlionwarrior("g_debug_antlionwarrior", "0");
...
static ConVar  sk_antlion_warrior_spit_speed("sk_antlion_warrior_spit_speed", "0", FCVAR_NONE, "Speed at which an antlion spit grenade travels.");
